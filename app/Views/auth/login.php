    ...
    <div class="d-flex align-items-center justify-content-center"
        ...
        <div class="login-box p-4 shadow-lg rounded-4 bg-white" style="width: 400px;">
            ...
            <div class="text-center">
                <p class="mb-1">
                    <a href="<?= base_url('forgot-password') ?>" class="text-decoration-none text-muted">Mot de passe
                        oublié ?</a>
                </p>
                <p>
                    <a href="<?= base_url('register') ?>" class="text-decoration-none text-primary fw-bold">Créer un
                        compte</a>
                </p>
            </div>
        </div>
